...
public class PrincipalGenerics {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PilhaGenerica<Eletronico> p1 = new PilhaGenerica<>(10); // Esta pilha armazena somente eletronicos
			p1.empilha(tablet);
			p1.empilha(notebook1);
			p1.empilha(notebook2);
			
			PilhaGenerica<String> p2 = new PilhaGenerica<>(12); // Esta pilha armazena somente strings
			p2.empilha("ABC");
			p2.empilha("DEF");
			p2.empilha("GHI");
